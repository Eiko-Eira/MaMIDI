...
- Refresh button to refresh sheets when new ones are added
- AntiRepeat on holding advance keys
- Key randomizer, before it rolled chords from a to z, now it will randomize the order
- Sheets now keep spaces and pipe letters but skips over them
